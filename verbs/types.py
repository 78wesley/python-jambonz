...
class Deepgramoptions:
    ...
    redact: Optional[Literal['pci', 'numbers', 'true', 'ssn']] = None
...
class Recognizer:
    ...
    interactionType: Optional[Literal['unspecified', 'discussion', 'presentation', 'phone_call', 'voicemail', 'voice_search', 'voice_command', 'dictation']] = None
    naicsCode: Optional[float] = None
    identifyChannels: Optional[bool] = None
    vocabularyName: Optional[str] = None
    vocabularyFilterName: Optional[str] = None
    filterMethod: Optional[Literal['remove', 'mask', 'tag']] = None
    model: Optional[str] = None
    outputFormat: Optional[Literal['simple', 'detailed']] = None
    profanityOption: Optional[Literal['masked', 'removed', 'raw']] = None
...
class Synthesizer:
    ...
    engine: Optional[Literal['standard', 'neural', 'generative', 'long-form']] = None
...
class Dub(Verb):
    verb = "dub"
    action: Literal['addTrack', 'removeTrack', 'silenceTrack', 'playOnTrack', 'sayOnTrack']
    track: str
    id: Optional[str] = None
...
@dataclass
class Target:
    type: Literal['phone', 'sip', 'user', 'teams']
    confirmHook: Optional[Any] = None
...
class Resourcereference:
    type: Optional[Literal['undefined_resource_type', 'wordset', 'compiled_wordset', 'domain_lm', 'speaker_profile', 'grammar', 'settings']] = None
    uri: Optional[str] = None
...
class Resource:
    ...
    weightName: Optional[Literal['defaultWeight', 'lowest', 'low', 'medium', 'high', 'highest']] = None
